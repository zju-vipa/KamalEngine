...
class HintDistiller(KDDistiller):
    def __init__(self, student, teacher, regressor, hint_layer=2, T=1.0, gamma=1.0, alpha=None, beta=None, stu_hooks=[], tea_hooks=[], out_flags=[], logger=None, viz=None):
        super(HintDistiller, self).__init__(student, teacher, T=T,
    ...
    def train(self, start_iter, max_iter, train_loader, optimizer, device=None):
        ...
        super(HintDistiller, self).train(start_iter,
