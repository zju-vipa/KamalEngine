...
# , import ImagePool, DataIter, clip_images
import collections
...
class CMISynthesizer(BaseSynthesis):
    def __init__(self, teacher, student, generator, nz, num_classes, img_size, feature_reuse=False,
    ...
    def synthesize(self, targets=None):
        ...
        for it in range(self.iterations):
            ...
            else: loss_cr = loss_inv.new_zeros(1)
