...
from kamal.core.criterions import AttentionLoss
...
class AttentionDistiller(KDDistiller):
    def __init__(self, logger=None, viz=None ):
        super(AttentionDistiller, self).__init__( logger, viz )
    
    def setup(self, 
              student, teacher, data_loader, optimizer, T=1.0, gamma=1.0, alpha=None, beta=None, 
