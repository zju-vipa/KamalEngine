...
class TaskBranchingAmalgamator(Engine):
    ...
    def setup(
        ...
        self.student = self.model = joint_student.to(self._device) #JointSegNet( student=student, teachers=teachers, phase='block' )
        ...
        with set_mode(self.student, training=False), \
            ...
            for batch in dataloader:
                ...
                for candidate_branch in range( n_blocks ):
                    ...
                    s_out_list = self.student( batch[0] )
                    t_out_list = [ teacher( batch[0] ) for teacher in self.teachers ]
