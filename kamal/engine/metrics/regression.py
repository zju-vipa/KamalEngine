...
class ScaleInveriantMeanSquaredError(Metric):
    def __init__(self):
        super(ScaleInveriantMeanSquaredError, self).__init__()
        self.reset()
...
class RelativeDifference(Metric):
    def __init__(self):
        super(RelativeDifference, self).__init__()
        self.reset()
...
class AbsoluteRelativeDifference(Metric):
    def __init__(self):
        super(AbsoluteRelativeDifference, self).__init__()
        self.reset()
...
class SquaredRelativeDifference(Metric):
    def __init__(self, attach_to=None ):
        super(SquaredRelativeDifference, self).__init__()
        self.reset()
