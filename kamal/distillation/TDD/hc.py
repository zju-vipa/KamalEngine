...
from kamal.distillation.TDD.feature_clustering.featuremap import load_embeddings, mean_embedding, mean_squared_embedding
...
from kamal.distillation.TDD.feature_clustering.cluster_tree import (
    to_binary_tree,
    KNN,
    update_knn,
    update_mean_var,
