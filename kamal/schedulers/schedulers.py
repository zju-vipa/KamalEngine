from torch.optim.lr_scheduler import _LRScheduler, MultiStepLR, ExponentialLR, CosineAnnealingLR, ReduceLROnPlateau
...
class PolynomialLR(_LRScheduler):
    def __init__(self, optimizer, max_iter, decay_iter=1, gamma=0.9, last_epoch=0):
