...
def to_tensor(pic, normalize=True, dtype=torch.long):
    ...
    Args:
        ...
        normalize: (bool): scaling the input image
        dtype: (int): type of output tensor. This arg works only when normalize=False.
