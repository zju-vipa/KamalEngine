...
from kamal import make_deterministic, preserve_memory, str2bool, get_logger_
from kamal.core.tasks.loss import get_loss_module
from kamal.utils.optim_utils import get_optimizer
from kamal.distillation.TDD.tdd import TDDistiller
...
def get_dataloader(cfg: Dict[str, Any]):
    ...
    train_dataset = get_dataset_tdd(split="train", **dataset_cfg)
    val_dataset = get_dataset_tdd(split="val", **dataset_cfg)
