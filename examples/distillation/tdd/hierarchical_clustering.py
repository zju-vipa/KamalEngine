...
from kamal.distillation.TDD.feature_clustering.cluster_tree import to_binary_tree, update_mean_var, KNN, \
    update_knn, merge_tree
from kamal.distillation.TDD.feature_clustering.clustering import clustering_by_layer, get_linkage_matrix
from kamal.distillation.TDD.hc import get_mean_embeddings, get_mean_squared_embeddings, get_embeddings
from kamal.vision.datasets import get_dataset_tdd
...
if __name__ == "__main__":
    ...
    dataset = get_dataset_tdd(name=args.dataset_name, root=args.dataset_root, split="train")
