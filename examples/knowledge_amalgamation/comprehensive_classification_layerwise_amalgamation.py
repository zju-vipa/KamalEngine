...
def main():
    ...
    trainer.add_callback( 
        ...
        callbacks=[
            callbacks.EvalAndCkpt(model=student, evaluator=car_evaluator, metric_name='car_acc', ckpt_prefix='layerwise_car'),
            callbacks.EvalAndCkpt(model=student, evaluator=aircraft_evaluator, metric_name='aircraft_acc', ckpt_prefix='layerwise_aircraft'),
        ] )
    trainer.add_callback(
