...
from hybrid import *
from kamal.loss import KDLoss, MS_SSIM_Loss
from kamal.metrics import StreamReconstructionMetrics, StreamSegmentationMetrics
...
if __name__ == '__main__':
    ...
    metrics_a = StreamReconstructionMetrics(data_range=1.0)
    metrics_b = StreamSegmentationMetrics(11)
