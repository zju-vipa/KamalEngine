...
class EvaluationVOC(EvaluationBase):
    """
    Distributed VOC evaluator
    """
    def __init__(
        self,
        ...
        self.metric = metrics.APMeter_VOC(criterion.num_classes)
    ...
    def update_prediction(
        ...
        gt_difficult = list(gt["is_difficult"] for gt in targets)
