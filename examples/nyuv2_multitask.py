...
def main():
    # Pytorch Part
    model = MultiTaskSegNet(out_channel_list=[13, 1]) # Seg + Depth
    ...
    # trainer
    task = [ kamal.tasks.StandardTask.segmentation(attach_to=0), kamal.tasks.StandardTask.monocular_depth(attach_to=1) ]
