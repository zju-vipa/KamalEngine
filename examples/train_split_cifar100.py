...
def main():
    # Pytorch Part
    model = vision.models.classification.cifar.wrn.wrn_40_2(num_classes=50)
    ...
    train_dst = split_cifar100.CIFAR100_PART('data/torchdata', train=True, part = args.part, transform=train_transform)
    val_dst = split_cifar100.CIFAR100_PART('data/torchdata', train=False, part = args.part, transform=val_transform)
